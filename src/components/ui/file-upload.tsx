  ...
  return (
    <div className='w-full' {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover='animate'
        className='p-10  rounded-lg cursor-pointer w-full relative overflow-hidden'
      >
        <input
          ref={fileInputRef}
          ...
          <div className='relative w-full mt-10 max-w-xl mx-auto' >
            ...
            {!files.length && (
              <motion.div
                ...
                className='absolute opacity-0 border border-dashed border-black inset-0 z-30 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md'
              ></motion.div>
            )}
          </div>
        </div>
